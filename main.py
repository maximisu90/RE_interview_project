...
class basicWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.par['Beamline energy']=Parameter(name='Beamline energy eV',current_val='250',set_val='250',validator=QIntValidator,val_bottom=240,val_top=2400)
...
if __name__ == '__main__':
    ...
    sys.exit(app.exec_())
    # a=business_logic()
    # dE=np.interp(12,a.Exit_slit,1200/a.R)
    # print(dE)
